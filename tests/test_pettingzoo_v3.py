...
from erisml.ethics.layers.strategic import StrategicLayer, StrategicAnalysisResult, CoalitionStabilityAnalysis
...
class TestErisPettingZooEnvV3(unittest.TestCase):
    ...
    def test_step_calculates_rewards(self):
        ...
        mock_judgement.get_party_vector.side_effect = lambda a: vec_0 if a == "agent_0" else vec_1
