...
We port the Geometric Ethics framework \cite{bond2026geometric}---validated across 20,030 texts and 11 languages, and examined in a preliminary, unpublished analysis \cite{thiele2026} (an unpublished single-author probe study that does not constitute peer-reviewed independent verification)---into clinical medicine.  The core claim:
