...
\begin{enumerate}
    ...
    \item The octahedral gauge group $V_4 \rtimes V_4$ (measured; the dihedral $D_4 \rtimes D_4$ posited) for the full Hohfeldian octad, with Wilson loop consistency tests;
