...
A monotone rule, which requires the temperature to grow no faster than linearly in the gap, would need a different lottery encoding to match P1 and P3, and we have not constructed one.
...
The geometric parameter entry counts the three fitted variances and, in parentheses, the thirteen named quantities of Table~\ref{tab:param_accounting}, before the coordinate constants of Table~\ref{tab:encodings}.
...
The four lottery targets that entered only the ranking step, P7, P11, P16, and P17, have MAE\,=\,5.0\%.
