...
On the Fraser--Nettle game targets ($N=212$) the MAE, computed from unrounded predictions, is 0.17\% on the two ultimatum-game targets and 2.29\% on the five public-goods rounds.
...
At $N=4{,}098$ each interval is about 2~pp wide, so the 2.6~pp error on P3 and the 4.8~pp error on P7 fall outside it, as do the larger errors on P16 and P17.
