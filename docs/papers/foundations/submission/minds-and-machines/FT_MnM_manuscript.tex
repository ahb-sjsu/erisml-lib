...
These nine dimensions are not an \emph{a priori} philosophical imposition. They are derived from a $3 \times 3$ scope/mode grid and have preliminary empirical support: linear probes trained on LaBSE embeddings decode all nine dimensions with F1 scores of 0.74--0.91 (mean 0.83), and cross-lingual transfer achieves F1 of 0.71--0.82 across six typologically diverse languages \citep{thiele2026}, as found in a preliminary, unpublished analysis. This cross-lingual transfer is carried by the multilingual (LaBSE) encoder, whose shared embedding space already aligns these languages, rather than by the moral geometry alone.
...
Lucas Thiele.
\newblock Probing geometric moral structure in multilingual embeddings (unpublished undergraduate research report).
\newblock UCLA, 2026.
