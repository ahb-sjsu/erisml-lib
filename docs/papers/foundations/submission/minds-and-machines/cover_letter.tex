...
\begin{enumerate}
    ...
    \item \textbf{Preliminary external analysis.} A preliminary, unpublished analysis by an undergraduate at another institution is consistent with the cross-lingual predictions of the framework, reporting moral structure that is language-invariant with moral and linguistic subspaces nearly orthogonal (shared variance $< 3\%$). This is a single-author probe study, not peer-reviewed independent verification.
\end{enumerate}
