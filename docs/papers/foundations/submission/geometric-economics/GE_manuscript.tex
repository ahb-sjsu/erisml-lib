...
These are the nine dimensions of the moral manifold identified in \cite{bond2026geometric}, empirically validated across 20,030 texts and 11 languages, and examined across 6 additional languages in a preliminary, unpublished analysis \cite{thiele2026}; the cross-lingual transfer is carried by the multilingual (LaBSE) encoder.  The claim is not that these dimensions are unique to ethics.  The claim is that they are the \emph{same dimensions on which economic decisions are made}---because economic decisions are a subset of moral decisions.
