  ...
  const concepts = {
    ...
    3: [
      ...
      { name: 'Hohfeld as Gauge',
        formal: 'Hohfeld\'s 8 jural positions (right/duty, privilege/no-right, power/liability, immunity/disability) form the octad — pairs linked by correlative and opposite relations, two commuting involutions generating a Klein four-group V4 symmetry (the dihedral group D4 is posited, pending empirical quarter-turn operations).',
        desc: 'Wesley Hohfeld\'s 1917 analysis of legal relations identified 8 fundamental normative positions connected by logical relations. Geometric ethics shows the measured relations — correlative swap and deontic negation — have the symmetry structure of the Klein four-group V4, making them amenable to gauge-theoretic treatment (the larger dihedral group D4 remains a posited, testable extension).',
        related: ['V4 Symmetry', 'Dear Ethicist Game'] },
    ],
    4: [
    ...
    5: [
      ...
      { name: 'Nine Dimensions',
        formal: 'Derived from 3x3 scope/mode grid. Scope: individual, relational, institutional. Mode: deontic, evaluative, epistemic. D1: consequences/outcomes, D2: rights/obligations, D3: fairness/justice, D4: autonomy, D5: trust, D6: social/relational impact, D7: identity/dignity/virtue, D8: institutional legitimacy, D9: epistemic status.',
        desc: 'The 9 dimensions arise from crossing three scopes (individual, relational, institutional) with three modes (deontic, evaluative, epistemic). Each dimension captures an independent aspect of moral evaluation. Every moral state is encoded as an attribute vector a(v) in R^9, scoring all nine dimensions simultaneously.',
    ...
    12: [
      ...
      { name: 'V4 x U(1) Gauge Group',
        formal: 'The measured gauge group of BIP is G = V4 x U(1)^H, where V4 is the Klein four-group capturing Hohfeldian correlative/opposite symmetries and U(1)^H is the continuous phase invariance for each Hohfeldian position (D4 x U(1)^H is posited, pending quarter-turn evidence).',
        desc: 'The BIP gauge group has two parts. The discrete component measured to date is the Klein four-group V4 — the commuting correlative and opposite operations on Hohfeldian positions; the full dihedral D4 is posited, awaiting evidence for quarter-turn operations. The continuous U(1) captures phase invariance. The gauge group was revised from SU(2) after empirical CHSH experiments — a concrete example of the framework being corrected by data.',
        related: ['Bond Invariance Principle', 'Hohfeld as Gauge'] },
    ],
    13: [
    ...
    15: [
      ...
      { name: 'Scalar Irrecoverability',
        formal: 'Theorem 15.1: Any continuous function f: R^n -> R (n >= 2) is non-injective. The information destroyed by projecting the moral tensor to a scalar is mathematically irrecoverable.',
        desc: 'This is the mathematical proof that scalar ethics is fundamentally inadequate. No continuous function from R^9 to R is one-to-one — infinitely many distinct moral tensors map to the same scalar value. No post-hoc analysis, no additional scalar, no clever encoding can recover what the projection destroys. The loss is provably permanent.',
        related: ['Scalar Collapse', 'Moment of Contraction'] },
    ],
    16: [
    ...
    17: [
      ...
      { name: 'Bond Index',
        formal: 'BI = (N_match - N_mismatch) / N_total, measuring the correlation between pairs of Hohfeldian assignments. Under V4 symmetry, correlative pairs should show BI close to 1.',
        desc: 'The Bond Index measures how well a respondent\'s moral judgments respect the correlative symmetry of Hohfeldian positions. A perfect score means every obligation has a matching claim, every liberty a matching no-right. The aggregate BI across many respondents tests whether moral reasoning has the V4 symmetry structure predicted by the framework.',
        related: ['Dear Ethicist Game', 'V4 Symmetry'] },
      { name: 'Cross-Lingual BIP',
        formal: 'BIP v10.16 experiments: 20,030 moral texts across 11 languages tested for deontic structure transfer. The obligation-permission axis transfers at 100% (model-mediated). Structural-to-surface ratio: 11.1x.',
        desc: 'The framework\'s dimensional structure predicts moral judgments 11.1 times better than surface linguistic features across 11 languages, confirming that the structure is real, not an artifact of English moral vocabulary. This cross-lingual invariance is strong evidence for the universality of the moral manifold.',
        related: ['Bond Invariance Principle', 'Nine Dimensions'] },
    ],
    18: [
    ...
    22: [
      ...
      { name: 'Hohfeldian Octad',
        formal: 'The 8 Hohfeldian positions (right, duty, privilege, no-right, power, liability, immunity, disability) organized by correlative and opposite relations with Klein four-group V4 symmetry (D4 posited).',
        desc: 'Hohfeld\'s 8 jural positions form a beautiful algebraic structure. Rights correlate with duties, privileges with no-rights, powers with liabilities, immunities with disabilities. The correlative and opposite relations are commuting involutions generating a V4 (Klein four-group) symmetry — the reflection subgroup of the square\'s symmetries; the full dihedral group D4 is posited, pending evidence for quarter-turn operations.',
        related: ['V4 Symmetry', 'Gauge Theory'] },
